...
#
train_batches = BatchGenerator(train_iter, 'question', 'question_sentiment_gold')
print("train batch", next(iter(train_batches)))

test_batches = BatchGenerator(test_iter, 'question', 'question_sentiment_gold')
print("test batch", next(iter(test_batches)))

dev_batches = BatchGenerator(dev_iter, 'question', 'question_sentiment_gold')
